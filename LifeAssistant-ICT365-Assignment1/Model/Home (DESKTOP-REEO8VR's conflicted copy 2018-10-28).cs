...
namespace LifeAssistant_ICT365_Assignment1.Model
{
    public class Home
    {
        ...
        {
            var childlat = events.Descendants(lle + "Home").Descendants(lle + "latitude").FirstOrDefault().Value;
            var childlong = events.Descendants(lle + "Home").Descendants(lle + "longitude").FirstOrDefault().Value;
